(function() {
    plaque.elements = {
            ...
            */
                                ...
                                $.each(categoryIntents, function(i, intents) {
                                    ...
                                    divIntent += '<div class="intent-div section accordion-section" id="overview-'+intent.category+'">';
                                        divIntent += '<div class="title-description">';
                                            divIntent += '<p class="intent-title" style="float: left;">'+intent.name+'</p>';
                                             divIntent += '<div id="show_documents_intent" style="float: left; margin-left:30px; margin-top: -3px; cursor: pointer;">';
                                                divIntent += '<i class="fa fa-paperclip" aria-hidden="true" style="font-size: 25px;"></i>';
                                             divIntent += '</div>';
                                            divIntent += '<p class="intent-description" style="clear:left;">'+intent.description+'</p>';
            ...
            getRequirementsForIntent: function(){
                var json_data = { 
                                "rating_system": "LEED EBOM",
                                "credit_name":   "SS Credit 1 : Site Selection",
                                "landing_message": "The following will help guide you through the documentation required for meeting LEED O+M Sustainable Sites Heat Island Reduction - Option 1 for Nonroof compliance. If approved during the third party GBCI review your project will earn 1 point.",

                                "requirements_list" : 
                                [ 
                                    { 
                                        "requirement_title"  : "Download the LEED form and populate the table with your project information", 
                                        "requirement_type"  : "upload"
                                    },
                                    { 
                                        "requirement_title"  : "Site plan indicating LEED project boundary, highlighting nonroof elements and measurements, hardscape area, and area of each nonroof measure clearly indicating all relevant strategies utilized at the project", 
                                        "requirement_type"  : "upload", 
                                    },
                                    { 
                                        "requirement_title"  : "Manufacturers’ documentation of SRI, SR, and paving permeability for all relevant strategies utilized at the project", 
                                        "requirement_type"  : "upload", 
                                    },
                                    { 
                                        "requirement_title"  : "Following is a narrative box, please use this to tell GBCI about any special circumstances or other messaging relevant for this credit.", 
                                        "requirement_type"  : "narrative", 
                                    }
                                ]
                             } 

                $.each(json_data.requirements_list, function(key, value) {
                    console.log(key);
                    console.log(value);
                });
                ...
                $("#show_documents_intent_modal .modal-header .rating-system").html(json_data.rating_system);
                $("#show_documents_intent_modal .modal-header .credit-name").html(json_data.credit_name);
                $("#show_documents_intent_modal .modal-body .landing-message").html(json_data.landing_message);
            }
    }; 
